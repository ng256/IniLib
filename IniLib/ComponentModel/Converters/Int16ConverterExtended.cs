...
namespace System.ComponentModel
{
    ...
    public class Int16ConverterExtended : BaseNumberConverterExtended
    {
        ...
        /// <summary>
        ///     Converts a string representation of a number to an <see cref="Int16"/> 
        ...
        /// <returns>The converted <see cref="Int16"/> value.</returns>
        ...
        /// <summary>
        ///     Converts an <see cref="Int16"/> value to its string representation 
        ...
        /// <returns>The string representation of the <see cref="Int16"/> value.</returns>
